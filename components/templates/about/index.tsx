  ...
  return (
    <>
      <SectionWrapper sectionId="about" className="max-w-[1000px]">
        ...
        <Typography
          variant="h4"
          className="text-lg max-w-[1000px] mx-auto  mb-4"
        >
          TechBySJ Empowerment Organization is a non-profit organization
          dedicated to empowering individuals, Schools and Corprates through
          technology. We believe that access to technology and digital literacy
          skills are essential for personal and professional growth in the
          modern world. Our organization strives to bridge the digital divide
          and create opportunities for underserved communities to thrive in the
          digital age.
        </Typography>
